...
SECRET_KEY = '1v#jan0c(4b6=3z*v*ungkew+$ed^v^ekni20!z*)oc3xaqvi('
...
DATABASES = {'default': dj_database_url.config(default='postgres://postgres:133407@localhost/carzone_db')}
